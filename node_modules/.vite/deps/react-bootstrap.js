...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react70.useContext)(TabContext_default);
  if (!context6)
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react71.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
...
var ToastFade = React122.forwardRef((props, ref) => (0, import_jsx_runtime125.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React124.forwardRef(({
  ...
  const context6 = (0, import_react72.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React126.forwardRef(({
  ...
  const delayRef = (0, import_react73.useRef)(delay);
  const onCloseRef = (0, import_react73.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react73.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react73.useMemo)(() => ({
    onClose
  }), [onClose]);
